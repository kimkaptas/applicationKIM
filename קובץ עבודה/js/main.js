...
document.addEventListener("DOMContentLoaded", function (event) {
    ...
    // האם הוא תומך והאם אני יכולה לקחת את הוידאו מהמכשיר עצמו
...
// שתי פונקציות הולכת להתקנה של הכפתור בראשונה להציג בשנייה מסתיר 
...
//אם עונים על כל התנאים אפשר להתקין- אין סיבה להציג אם יש כבר את האפליקציה פונים למשתנה עם האירוע של ההתקנה 
